...
const ChangePhoneNumber = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      const response = await axios.post("/api/v1/phoneauth", { ph: ph });
      ...
      await axios.post("/api/v1/changeph", { ph: ph }, {
        headers: { 'Authorization': `Bearer ${token}` }
      });

      await axios.post('/api/v1/clear-cache', null, {
        headers: { 'Authorization': `Bearer ${token}` }
      });
